...
function ShipperPortal() {
  ...
  return (
    <div>
      ...
      <Alert type="info" msg="Shippers get their own login at shippers.roadledger.com — no broker needed. They post loads, choose a carrier, e-sign the rate confirmation, and release payment all in one place." />
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:16 }}>
        <Card>
